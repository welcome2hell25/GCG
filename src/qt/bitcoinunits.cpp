...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("GCG");
    case mBTC: return QString("mGCG");
    case uBTC: return QString::fromUtf8("μGCG");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("GULFCOINGOLDs"));
    case mBTC: return QString(QObject::tr("Milli-GULFCOINGOLDs (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-GULFCOINGOLDs (1 / 1,000,000)"));
    default: return QString("???");
    }
}
