...
{
    resize(850, 550);
    setWindowTitle(tr("GULF COIN GOLD") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a GULFCOINGOLD address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About GULFCOINGOLD"), this);
    aboutAction->setStatusTip(tr("Show information about GULFCOINGOLD"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for GULFCOINGOLD"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your GULFCOINGOLD addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified GULFCOINGOLD addresses"));
    secondAuthAction = new QAction(QIcon(":/icons/key"), tr("Second &auth..."), this);
    secondAuthAction->setStatusTip(tr("Second auth with your GULFCOINGOLD addresses"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("GULFCOINGOLD client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("GULFCOINGOLD client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to GULFCOINGOLD network", "", count));
}
...
{
    QString strTitle = tr("GULF COIN GOLD") + " - ";
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid GULFCOINGOLD address or malformed URI parameters."));
    }
