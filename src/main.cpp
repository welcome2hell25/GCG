...
unsigned int nStakeMinAge = 12 * 24 * nOneHour; // 12 days as zero time weight
unsigned int nStakeMaxAge = 3.5 * 24 * nOneHour; // 3.5 days as full weight
...
const string strMessageMagic = "GULFCOINGOLD Signed Message:\n";
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("GULFCOINGOLD-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in GULFCOINGOLD
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // GULFCOINGOLD: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "GULFCOINGOLD", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "MY GULF COIN GENESIS";
        CTransaction txNew;
        txNew.nTime = 1510105017;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1510105017;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 553827; // !fTestNet ? 1575379 : 46534;
