GULFCOINGOLD-qt: Qt4 GUI for GULFCOINGOLD
===============================
...
Alternatively, install Qt Creator and open the `GULFCOINGOLD-qt.pro` file.

An executable named `GULFCOINGOLD-qt` will be built.
...
A warning for people using the *static binary* version of GULFCOINGOLD on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of GULFCOINGOLD is linked against libdb5.3.
...
installed causes GULFCOINGOLD-qt to crash intermittently.  The issue has been reported as `launchpad bug 857790`_, but
isn't yet fixed.
